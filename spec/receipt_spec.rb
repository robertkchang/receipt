...
describe "Receipt" do
  ...
  it "should calculate correctly with the given single input" do
    ...
    receipt.to_s.should eql "===  Your Receipt  ===#{ReceiptHelper::CR_LF}1 music CD: 16.49#{ReceiptHelper::CR_LF}Sales taxes: 1.50#{ReceiptHelper::CR_LF}Total: 16.49"
  end
  ...
  it "should calculate correctly with the given multiple inputs" do
    ...
    receipt.to_s.should eql "===  Your Receipt  ===#{ReceiptHelper::CR_LF}1 music CD: 16.49#{ReceiptHelper::CR_LF}1 packet of headache pills: 9.75#{ReceiptHelper::CR_LF}1 imported bottle of perfume: 54.65#{ReceiptHelper::CR_LF}Sales taxes: 8.65#{ReceiptHelper::CR_LF}Total: 80.89"
  end
  ...
  it "should calculate correctly with the given use case" do
    ...
    receipt.to_s.should eql "===  Your Receipt  ===#{ReceiptHelper::CR_LF}1 book: 12.49#{ReceiptHelper::CR_LF}1 music CD: 16.49#{ReceiptHelper::CR_LF}1 chocolate bar: 0.85#{ReceiptHelper::CR_LF}Sales taxes: 1.50#{ReceiptHelper::CR_LF}Total: 29.83"
  end
  ...
  it "should calculate correctly with the given second use case" do
    ...
    receipt.to_s.should eql "===  Your Receipt  ===#{ReceiptHelper::CR_LF}1 imported box of chocolates: 10.50#{ReceiptHelper::CR_LF}1 imported bottle of perfume: 54.65#{ReceiptHelper::CR_LF}Sales taxes: 7.65#{ReceiptHelper::CR_LF}Total: 65.15"
  end
  ...
  it "should calculate correctly with the given third use case" do
    ...
    receipt.to_s.should eql "===  Your Receipt  ===#{ReceiptHelper::CR_LF}1 imported bottle of perfume: 32.19#{ReceiptHelper::CR_LF}1 bottle of perfume: 20.89#{ReceiptHelper::CR_LF}1 packet of headache pills: 9.75#{ReceiptHelper::CR_LF}1 box of imported chocolates: 11.85#{ReceiptHelper::CR_LF}Sales taxes: 6.70#{ReceiptHelper::CR_LF}Total: 74.68"
  end
  ...
  it "should calculate correctly with the given fourth use case" do
    ...
    receipt.to_s.should eql "===  Your Receipt  ===#{ReceiptHelper::CR_LF}1 can of soup: 0.95#{ReceiptHelper::CR_LF}1 bowl of cereal: 11.50#{ReceiptHelper::CR_LF}10 cases of nuts: 16.50#{ReceiptHelper::CR_LF}20 imported bottles of shampoo: 57.55#{ReceiptHelper::CR_LF}Sales taxes: 10.20#{ReceiptHelper::CR_LF}Total: 86.50"
  end
  ...
  it "should calculate correctly with the given fifth use case" do
    ...
    receipt.to_s.should eql "===  Your Receipt  ===#{ReceiptHelper::CR_LF}10 chocolate bar: 8.50#{ReceiptHelper::CR_LF}Sales taxes: 0.00#{ReceiptHelper::CR_LF}Total: 8.50"
  end
